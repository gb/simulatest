...
public class NodeTest {
	...
	public void createNodes() {
		...
		tree.addChild("jose", "silvia");
		tree.addChild("jose", "mario");
		tree.addChild("jose", "raimundo");
		tree.addChild("mario", "antonio");
		tree.addChild("mario", "jozefa");

		jose = findNode("jose");
		silvia = findNode("silvia");
		mario = findNode("mario");
		raimundo = findNode("raimundo");
		antonio = findNode("antonio");
		jozefa = findNode("jozefa");
	}
	...
	private Node<String> findNode(String value) {
		...
		throw new IllegalArgumentException("Node not found: " + value);
	}
